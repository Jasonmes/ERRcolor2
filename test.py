...
imgCanny2 = cv2.minAreaRect(imgCanny)
'''
epsilon = 0.01 * cv2.arcLength(imgCanny2, True)
approx = cv2.approxPolyDP(imgCanny2, epsilon, True)
'''
...
cv2.resizeWindow("w2", 640, 480)
cv2.imshow("w2",imgCanny2)
